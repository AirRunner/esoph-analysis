...
With this test, the model gives around 70% correct predictions, which is still very good. Note that, during our test, this value seemed to tend to be similar to the $R^2$, but this should be a coincidence.
