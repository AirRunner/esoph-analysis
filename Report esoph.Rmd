...
cat("Young and clean: ", round(young.clean*100, 1), "%",
    "\nYoung and poor: ", round(young.poor*100, 1), "%",
    "\nMiddle: ", round(middle*100, 1), "%",
    "\nOld and clean: ", round(old.clean*100, 1), "%",
    "\nOld and poor: ", round(old.poor*100, 1), "%")
```

In our prediction tests, "clean" means that the person do not drink or smoke, and "poor" is the opposite.
