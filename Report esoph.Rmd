...
As we want to test the independence of cases proportion and age, we should create two factors, one combining `ncases` and `ncontrols`, and the other being `agegp`. With the built-in function `chisq.test`, the independence $\chi^2$ test will be performed between these two factors.
