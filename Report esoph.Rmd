...
$\chi^2$ test: $\chi^2 = \sum_{i,j}\frac{\left(o_{ij} - c_{ij}\right)^2}{c_{ij}}$
...
In the end, as shown above, we see that tobacco is less correlated than age or alcohol with the increase in cancer cases, but that the value is very high from the outset. In other words, a person who smokes little is almost as likely to develop cancer of the oesophagus as a person who smokes much more, unlike age or alcohol, for which the probability increases gradually.
